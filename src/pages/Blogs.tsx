...
const Blogs = () => {
  const blogPosts = [
    ...
    },
    {
      ...
      date: "March 5, 2024",
      image: "https://images.unsplash.com/photo-1517022812141-23620dba5c23?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      readTime: "6 min read"
    },
    {
      id: 4,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link to="/blogs" className="text-green-600 font-medium">Blogs</Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Stay updated with the latest insights on dairy farming, A2 milk benefits, 
            and traditional cow care practices from our experts.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            <Card key={post.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardHeader>
                <CardTitle className="text-green-700 line-clamp-2">{post.title}</CardTitle>
        ...
        <div className="mt-16 bg-green-600 rounded-lg p-8 text-center text-white">
          ...
          <p className="mb-6">Subscribe to our newsletter for the latest farm updates and dairy insights.</p>
        ...
        <div className="mt-16 bg-white rounded-lg p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Blog Categories</h2>
          <div className="grid md:grid-cols-4 gap-4 text-center">
            <div className="p-4 bg-green-50 rounded-lg">
              <h3 className="font-semibold text-green-700">Cow Care</h3>
              <p className="text-sm text-gray-600 mt-2">Traditional and modern practices</p>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              <h3 className="font-semibold text-green-700">A2 Milk Benefits</h3>
              <p className="text-sm text-gray-600 mt-2">Health and nutrition insights</p>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              <h3 className="font-semibold text-green-700">Sustainable Farming</h3>
              <p className="text-sm text-gray-600 mt-2">Eco-friendly practices</p>
            </div>
            <div className="p-4 bg-green-50 rounded-lg">
              <h3 className="font-semibold text-green-700">Farm Life</h3>
              <p className="text-sm text-gray-600 mt-2">Daily life and stories</p>
            </div>
          </div>
        </div>
      </div>
