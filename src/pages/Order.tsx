    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <Link to="/order" className="text-green-600 font-medium">Order</Link>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Order Fresh Products</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Order fresh A2 milk and dairy products directly from our farm. 
            We deliver within 24 hours of milking.
          </p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              <h3 className="font-semibold text-green-700 mb-2">Fresh Delivery</h3>
              <p className="text-gray-600">All products delivered within 24 hours of production</p>
            </div>
            <div className="text-center">
              <h3 className="font-semibold text-green-700 mb-2">Free Delivery</h3>
              <p className="text-gray-600">Free delivery for orders above ₹500 within 10km</p>
            </div>
            <div className="text-center">
              <h3 className="font-semibold text-green-700 mb-2">Quality Guarantee</h3>
